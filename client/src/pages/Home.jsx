  ...
  return (
    <div>
      <div className="min-h-screen bg-gradient-to-br from-green-50 to-blue-50">
        <header className="flex justify-between items-center px-8 py-6">
          <div className="flex items-center text-2xl font-bold text-gray-800">
            ...
            <svg width="32" height="32" viewBox="0 0 24 24" fill="#2ecc40" xmlns="http://www.w3.org/2000/svg" style={{marginLeft: "0.3rem"}}>
              <path d="M12 1L9 9H1l7 5-3 9 8-6 8 6-3-9 7-5h-8z"/>
            </svg>
          </div>
        ...
        <div className="flex flex-col items-center justify-center text-center px-8 py-16">
          <h1 className="text-5xl md:text-6xl font-bold text-gray-800 mb-6 leading-tight">
            Your Voice <br />
            Our <span className="text-eco-green">Responsibility</span>
          </h1>
          <p className="text-xl text-gray-600 max-w-3xl mb-8 leading-relaxed">
            Report civic issues and grievances instantly. Government responds promptly, community participates actively. Let's build a responsive and accountable governance system together.
          </p>
      ...
      <section className="py-16 px-8 bg-white">
        ...
        <p className="text-xl text-center text-gray-600 mb-12">Easy-to-use citizen grievance redressal platform</p>
        <div className="grid md:grid-cols-3 gap-8 max-w-6xl mx-auto">
          <div className="bg-green-50 border-l-4 border-green-500 p-8 rounded-lg shadow-md">
            ...
            <h3 className="text-xl font-semibold text-gray-800 mb-3">Quick Grievance Reporting</h3>
            <p className="text-gray-600">Precisely mark complaint locations on the map, upload photos and detailed descriptions for quick understanding by government authorities</p>
          </div>
          <div className="bg-blue-50 border-l-4 border-blue-500 p-8 rounded-lg shadow-md">
            ...
            <p className="text-gray-600">Relevant departments handle complaints promptly, update resolution progress, ensuring every citizen grievance gets proper attention and resolution</p>
          </div>
          <div className="bg-orange-50 border-l-4 border-orange-500 p-8 rounded-lg shadow-md">
            ...
            <h3 className="text-xl font-semibold text-gray-800 mb-3">Community Participation</h3>
            <p className="text-gray-600">Citizens can vote on important issues, participate in discussions, and work together with authorities to resolve community grievances</p>
          </div>
        </div>
      </section>
      ...
      <section className="py-16 px-8 bg-gray-50">
        ...
        <p className="text-xl text-center text-gray-600 mb-12">Three simple steps to report and resolve your grievances</p>
        <div className="flex flex-col md:flex-row justify-center items-center gap-8 max-w-4xl mx-auto">
          ...
          <div className="text-center">
            ...
            <h3 className="text-xl font-semibold text-gray-800 mb-3">Report Grievance</h3>
            <p className="text-gray-600">Mark complaint locations on the map, upload photos, and provide detailed descriptions of your issue</p>
          </div>
          <div className="text-center">
            ...
            <h3 className="text-xl font-semibold text-gray-800 mb-3">Track & Engage</h3>
            <p className="text-gray-600">Track resolution status, vote for important issues, join discussions, and help resolve civic problems</p>
          </div>
        </div>
      </section>
      ...
      <footer className="bg-gray-800 text-white py-12">
        <div className="max-w-6xl mx-auto px-8">
          <div className="grid md:grid-cols-4 gap-8">
            <div>
              ...
              <p className="text-gray-400">Every voice matters, every complaint counts</p>
            </div>
            <div>
              <h4 className="text-lg font-semibold mb-4">Platform Features</h4>
              <ul className="space-y-2 text-gray-400">
                <li>Citizen Grievance Reporting</li>
                <li>Real-time Status Tracking</li>
                <li>Government Response Updates</li>
                <li>Community Voting & Discussion</li>
              </ul>
            </div>
            <div>
            ...
            <div>
              ...
              <ul className="space-y-2 text-gray-400">
                ...
                <li>Email: support@civicvoice.com</li>
        ...
        <div className="border-t border-gray-700 mt-8 pt-8 text-center text-gray-400">
          © 2024 CivicVoice. Empowering citizens, ensuring accountability.
        </div>
      </footer>
    </div>
  );
