...
function ReportIssue() {
  ...
  try {
    // Axios already sends token via interceptor
    ...
    <div className="min-h-screen bg-gradient-to-br from-green-50 to-blue-50 p-4">
      <div className="max-w-2xl mx-auto bg-white rounded-lg shadow-lg p-8">
        <div className="flex gap-4 mb-6">
          <Link to="/" className="inline-block px-4 py-2 text-eco-green border border-eco-green rounded-lg hover:bg-eco-green hover:text-white transition-colors">
            Home
          </Link>
          <button 
            onClick={() => window.location.href = "/chatbot.html"}
            className="inline-block px-4 py-2 text-white bg-eco-green border border-eco-green rounded-lg hover:bg-green-700 transition-colors"
          >
            Ask BOT
          </button>
        </div>
